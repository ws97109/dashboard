...
var ChartVisualizer = (function() {
    ...
    function drawDoublePieChart(overallProgress, categories, highlightId) {
        ...
        outerGradient.addColorStop(0, '#10b981');
        outerGradient.addColorStop(1, '#059669');
    ...
    function drawProgressArrows(categories) {
        ...
        categories.forEach(function(category, index) {
            ...
            var lightColor = CommonUtils.hexToRGBA(category.color, 0.25);
            
            arrowItem.innerHTML = 
                '<div class="arrow-shape" style="--arrow-border-color:#5D873D ;">' +
                '<div class="arrow-fill" style="width: 0%; background: ' + lightColor + ';"></div>' +
